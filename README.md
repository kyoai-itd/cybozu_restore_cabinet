...
正しいフォルダにないファイルはこちらから探すと見つかるかもしれません。  
掲示板の添付ファイルやそのコメントの添付ファイルが復元されるものと推測しています。  
ファイルのタイトル部分は復元されません。  
世代履歴と思われるファイルは復元されません。  
...
# 公開について
うまく動作すれば公式Xやその他公式SNSで御礼をいただくことなどを条件に無償配布したいと考えています。  
プライベートのリポジトリに招待するか、MicrosoftのOneDriveで共有するかを検討しています。  
現在X（Twitter）で需要を調査しているところです。  
