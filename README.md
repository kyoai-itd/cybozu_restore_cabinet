...
（組織フォルダはすべての組織分作成されますので、不要なフォルダは後から削除してください）  
...
ごみ箱にあるファイルは「削除ファイル」フォルダに復元されます。  
ファイルのタイトル部分は復元されません。  
...
# 公開・配布について  
公開方針が決まるまでは、以下のプライベートのリポジトリに招待します。  
https://github.com/kyoai-itd/cybozu_restore_cabinet_private  
